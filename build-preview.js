...
const situational = fs.readFileSync(path.join(root, "data/situational.json"), "utf8");
const version = fs.readFileSync(path.join(root, "data/version.json"), "utf8");
